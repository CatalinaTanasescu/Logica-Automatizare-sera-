...
#define Motor_ventilator_Pin GPIO_PIN_0
#define Motor_ventilator_GPIO_Port GPIOC
#define RMII_MDC_Pin GPIO_PIN_1
#define RMII_MDC_GPIO_Port GPIOC
#define Led_rosu_Pin GPIO_PIN_2
#define Led_rosu_GPIO_Port GPIOC
...
#define Led_albastru_Pin GPIO_PIN_1
#define Led_albastru_GPIO_Port GPIOB
#define Led_verde_Pin GPIO_PIN_11
#define Led_verde_GPIO_Port GPIOF
...
#define UCPD_FLT_EXTI_IRQn EXTI7_IRQn
